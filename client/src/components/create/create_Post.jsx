...
import bannerImg from "./b3.jpg"; // Your banner image
      ...
      <FormContainer>
        ...
        <StyledFormControl>
          <Box display="flex" alignItems="center">
            ...
            <StyledInputBase placeholder="Enter Blog Title" fullWidth onChange={(e) => handleChange(e)} name="title" required />
          </Box>
        </StyledFormControl>
        ...
        {/* Publish Button */}
        <StyledButton variant="contained" fullWidth endIcon={<SendIcon />}onClick={savePost}>
          Publish
        </StyledButton>
      </FormContainer>
    </>
